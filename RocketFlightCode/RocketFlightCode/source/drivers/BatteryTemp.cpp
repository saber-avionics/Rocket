...
// */
//bool MCP9808::begin(TwoWire *theWire) {
//  _wire = theWire;
...
// *    @return True if initialization was successful, otherwise false.
// */
//bool MCP9808::begin(uint8_t addr, TwoWire *theWire) {
//  _i2caddr = addr;
//  _wire = theWire;
//  return init();
//}
...
// */
//void MCP9808::shutdown_wake(boolean sw) {
...
// *    @param  value
// */
//void MCP9808::write8(uint8_t reg, uint8_t value)
//{
//  _wire -> beginTransmission(_i2caddr);
//  _wire -> write((uint8_t)reg);
//  _wire -> write(value);
